...
namespace ReduxArch.Util
{
    public static class Validation
    {
        ...
        public static bool IsUSState(string stateName)
        {
            ...
            return (stateCodesArray.Contains(stateName) || stateNamesArray.Contains(stateName));
        }
        ...
        {
            return Regex.IsMatch(time, RegexPattern.TIME);
        }

        #region Validate Parameter

        public static bool ValidateParameter(ref string param, bool checkForNull, bool checkIfEmpty, bool checkForCommas)
        {
            if (param == null)
            {
                return !checkForNull;
        ...
        {
            bool validate = ValidateParameter(ref param, checkForNull, checkIfEmpty, checkForCommas);
            if (param != null)
            {
                if (validate == true)
                {
        ...
        public static bool ValidateParameter(this string param, bool checkForNull, bool checkIfEmpty, bool checkForCommas)
        {
            
            return ValidateParameter(ref param, checkForNull, checkIfEmpty, checkForCommas);

        }

        public static bool ValidateParameter(this string param, bool checkForNull, bool checkIfEmpty, bool checkForCommas, int maxSize)
        {
            return ValidateParameter(ref param, checkForNull, checkIfEmpty, checkForCommas, maxSize);
        }
