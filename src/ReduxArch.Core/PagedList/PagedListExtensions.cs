...
namespace ReduxArch.Core.PagedList
{
    ...
    public static class PagedListExtensions
    {
        ...
        public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> superset, int index, int pageSize, int totalItemCount)
        {
            return new PagedList<T>(superset, index, pageSize, totalItemCount);
        }
    }
}